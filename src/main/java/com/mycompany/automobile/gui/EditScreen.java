...
public class EditScreen extends javax.swing.JFrame {
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
		controller.edit(auto, txtModel.getText(), txtBrand.getText(), txtEngine.getText(),
			txtColor.getText(), txtPlate.getText(),
			(String) cmbNumDoors.getSelectedItem());

		message("Load", "Data has been edited correctly", "Information");
	...
	private void loadData(int id) {
		auto = controller.findAutomobile(id);
		txtModel.setText(auto.getModel());
		txtBrand.setText(auto.getBrand());
		txtEngine.setText(auto.getEngine());
		txtColor.setText(auto.getColor());
		txtPlate.setText(auto.getPlate());
		cmbNumDoors.setSelectedItem(auto.getNumberOfDoors());
	}
}
